  ...
  return (
    <div className="bg-black w-full h-auto  py-10">
      <div className="container mx-auto flex ml-14 justify-between text-white">
        {/* Left Column */}
        <div className="w-1/3">
          <Link href="/signin"><p className="text-xs uppercase mb-2">Find A Store</p></Link>
          <Link href="/JoinUs"><p className="text-xs uppercase mb-2">Become A Member</p></Link>
          <Link href="/JoinUs"><p className="text-xs uppercase mb-2">Sign Up for Email</p></Link>
          <Link href="/help"><p className="text-xs uppercase mb-2">Send Us Feedback</p></Link>
        ...
        <div className="w-1/3 mr-4">
          ...
          <p className="text-sm text-gray-400 mb-2">Contact Us On Nike.com Inquiries</p>
          <p className="text-sm text-gray-400 mb-2">Contact Us On All Other Inquiries</p>
        </div>
